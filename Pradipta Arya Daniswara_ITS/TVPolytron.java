public class TVPolytron extends TVDefault implements Control 
{
	public TVPolytron()
	{
		super();
	...
	public TVPolytron(Channel[] channel, int arrayCounter, int volume, int activeChannel, boolean isOn)
	{

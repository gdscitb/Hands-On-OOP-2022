public class TVSamsung extends TVDefault implements Control 
{
	public TVSamsung()
	{
		super();
	...
	public TVSamsung(Channel[] channel, int arrayCounter, int volume, int activeChannel, boolean isOn)
	{
